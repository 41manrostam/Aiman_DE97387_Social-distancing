...
{
  //float distance = calcDistance(); //initialize distance equal as result from calculation
  ...
  if(posi <= 100) //minimum distance between user and other people
  {
    ...
    tone(buzzerPin, 200, 100); //tone(pin, frequency, duration)//set the pin, frequency of buzzer and the duration of the tone
